...
$(window).on("load", function () {
    ...
    $(document).on('change', '.drop-area .uploader', function (e) {
        ...
        fileReader.onload = (function () {
            ...
            const stop_accordion_template = '<div class="accordion_two"><div class="accordion_header_two">[{stopIndex}] {stopName} to {nextName}<div class="i_box"><i class="one_i"></i></div></div><div class="accordion_inner_two"> {stopEnabled} {stopUseDefaultTimeTable} {stopMode} {stopInterval} {stopEnd}<div class="box_one"><table class="dept-table" id="departures-{lineId}-{stopIndex}"><thead><tr><th>Departures</th></tr></thead>{tables}</table><div class="box_one_column">{shiftText}<div class="box_buttons">{shiftButton}{CopyShiftButton}{CopyButton}{DeleteButton}</div></div></div></div></div>';
